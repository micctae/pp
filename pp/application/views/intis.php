...
<div id="container">
	<h1>Ingreso de Tickets</h1>

	<div id="body">
		<p>Estado del ticket. <?php echo "(".$codi.") Numero: ".$numero; ?></p>


		<code> #<?php echo $estado;?> </code>

	<form action="<?php echo base_url('yy')?>" method="get">

<!--<p align="center">Codigo : </p><p align="center"><input name="mf" autocomplete="off" size="90" maxlength="95" id="ami" class="inputstyle" /></p>
-->	
	Codigo : <p ><input name="mf" autocomplete="off" size="90" maxlength="95" id="ami" class="inputstyle" /></p>
