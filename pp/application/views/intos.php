...
<div id="container">
	<h1>Ingreso Manual de ventas de tickets </h1>
	...
	<form action="<?php echo base_url('yy/amano')?>" method="get">

	Codigo : <p ><input name="mf" autocomplete="off" size="10" maxlength="15" id="ami" class="inputstyle" /></p>
